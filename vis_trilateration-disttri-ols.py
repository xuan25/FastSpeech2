...
tasks = [
    Task(
        ...
        task_output="output/plots/trilateration-disttri-ols/prosody-predictor_sentiment-input.png",
    ...
    Task(
        ...
        task_output="output/plots/trilateration-disttri-ols/prosody-predictor_sentiment-input_contrastive-0.png",
    ...
    Task(
        ...
        task_output="output/plots/trilateration-disttri-ols/prosody-predictor_sentiment-input_contrastive-0.01.png",
    ...
    Task(
        ...
        task_output="output/plots/trilateration-disttri-ols/prosody-predictor_sentiment-input_contrastive-0.1.png",
...
for task in tasks:
    ...
    for tl in target_labels:
        ...
        coords[tl] = trilaterate(dA, dB, dC)
