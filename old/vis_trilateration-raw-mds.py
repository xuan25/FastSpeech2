...
tasks = [
    Task(
        ...
        task_output="output/plots/trilateration-raw-mds/prosody-predictor_sentiment-input.png",
    ...
    Task(
        ...
        task_output="output/plots/trilateration-raw-mds/prosody-predictor_sentiment-input_contrastive-0.png",
    ...
    Task(
        ...
        task_output="output/plots/trilateration-raw-mds/prosody-predictor_sentiment-input_contrastive-0.01.png",
    ...
    Task(
        ...
        task_output="output/plots/trilateration-raw-mds/prosody-predictor_sentiment-input_contrastive-0.1.png",
