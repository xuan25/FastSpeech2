...
INPUT_PATHS = [
    "output/prosody_predictor/default",
]

OUTPUT_PATH = "output/prosody_predictor/default_migrated"

NAMING_MAP = {
    "Loss/duration_loss": "Loss/duration_loss_std",
    "Loss/energy_loss": "Loss/energy_loss_std",
    "Loss/pitch_loss": "Loss/pitch_loss_std",
...
def main():
    ...
    for summary_rel_dir in summary_rel_dirs:
        ...
        # remap tags according to NAMING_MAP
        averaged_scalar_stats = {
            NAMING_MAP.get(tag, tag): values for tag, values in averaged_scalar_stats.items()
        }
