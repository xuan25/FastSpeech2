...
- [x] python train_prosody_predictor_contrastive.py --dataset_config config/dataset_expresso_style.yaml --train_config config/train_prosody_predictor.yaml --model_config config/model_label_input.yaml --output_dir output/expresso/style/prosody_predictor/embedding_input/contrastive7_0

- [x] python train_prosody_predictor_contrastive.py --dataset_config config/dataset_expresso_style.yaml --train_config config/train_prosody_predictor_contrastive-0.1.yaml --model_config config/model_label_input.yaml --output_dir output/expresso/style/prosody_predictor/embedding_input/contrastive7_0.1

- [x] python train_prosody_predictor_contrastive.py --dataset_config config/dataset_expresso_style.yaml --train_config config/train_prosody_predictor_contrastive-0.1_0.1.yaml --model_config config/model_label_input.yaml --output_dir output/expresso/style/prosody_predictor/embedding_input/contrastive7_0.1_0.1

- [-] python train_prosody_predictor_contrastive.py --dataset_config config/dataset_expresso_style.yaml --train_config config/train_prosody_predictor_contrastive-1.yaml --model_config config/model_label_input.yaml --output_dir output/expresso/style/prosody_predictor/embedding_input/contrastive7_1
...
## sentiment_input - contrastive7 - no_whisper

<!-- - [ ] python train_prosody_predictor_contrastive.py --dataset_config config/dataset_expresso_style_no_whisper.yaml --train_config config/train_prosody_predictor.yaml --model_config config/model_label_input.yaml --output_dir output/expresso/style/prosody_predictor/embedding_input/contrastive7_0 -->

- [-] python train_prosody_predictor_contrastive.py --dataset_config config/dataset_expresso_style_no_whisper.yaml --train_config config/train_prosody_predictor_contrastive-1.yaml --model_config config/model_label_input.yaml --output_dir output/expresso/style/prosody_predictor/embedding_input/contrastive7_1_no_whisper

<!-- - [ ] python train_prosody_predictor_contrastive.py --dataset_config config/dataset_expresso_style_no_whisper.yaml --train_config config/train_prosody_predictor_contrastive-0.1_0.1.yaml --model_config config/model_label_input.yaml --output_dir output/expresso/style/prosody_predictor/embedding_input/contrastive7_0.1_0.1 -->


## sentiment_input - contrastive7 - sentiment

- [-] python train_prosody_predictor_contrastive.py --dataset_config config/dataset_expresso_sentiment.yaml --train_config config/train_prosody_predictor.yaml --model_config config/model_label_input.yaml --output_dir output/expresso/sentiment/prosody_predictor/embedding_input/default

- [-] python train_prosody_predictor_contrastive.py --dataset_config config/dataset_expresso_sentiment.yaml --train_config config/train_prosody_predictor_contrastive-1.yaml --model_config config/model_label_input.yaml --output_dir output/expresso/sentiment/prosody_predictor/embedding_input/contrastive7_1



## 251201

- [-] python train_prosody_predictor_contrastive.py --dataset_config config/dataset_expresso_style_no_whisper.yaml --train_config config/train_prosody_predictor_contrastive_1_0.1.yaml --model_config config/model_label_input.yaml --output_dir output/expresso/style/prosody_predictor/embedding_input/contrastive7_1_0.1_no_whisper

- [-] python train_prosody_predictor_contrastive.py --dataset_config config/dataset_expresso_style_no_whisper.yaml --train_config config/train_prosody_predictor_contrastive_0.1_0.1.yaml --model_config config/model_label_input.yaml --output_dir output/expresso/style/prosody_predictor/embedding_input/contrastive7_0.1_0.1_no_whisper

- [-] python train_prosody_predictor_contrastive.py --dataset_config config/dataset_expresso_sentiment.yaml --train_config config/train_prosody_predictor_contrastive_1_0.1.yaml --model_config config/model_label_input.yaml --output_dir output/expresso/sentiment/prosody_predictor/embedding_input/contrastive7_1_0.1

- [-] python train_prosody_predictor_contrastive.py --dataset_config config/dataset_expresso_sentiment.yaml --train_config config/train_prosody_predictor_contrastive_0.1_0.1.yaml --model_config config/model_label_input.yaml --output_dir output/expresso/sentiment/prosody_predictor/embedding_input/contrastive7_0.1_0.1
...
<!-- python compute_target_loc_pca.py \
    ...
    --anchor_loc_transform_file output/expresso/style/prosody_predictor_gt/gt/loc_anchor_train_no_whisper/duration_anchor_pca_transform.pkl \
    ...
    --output_dir output/expresso/style/prosody_predictor/embedding_input/contrastive7_0.1_0.1/loc_no_whisper/train/duration/pca \
...
<!-- python plot_loc.py \
    --anchor_loc_file output/expresso/style/prosody_predictor_gt/gt/loc_anchor_train/duration_anchor_loc_pca.csv \
    --target_loc_dir output/expresso/style/prosody_predictor/embedding_input/contrastive7_0.1_0.1/loc_no_whisper/train/duration/pca \
    --output_file output/expresso/style/prosody_predictor/embedding_input/contrastive7_0.1_0.1/vis_no_whisper/train/duration/pca.png \
    --tag expresso_style_contrastive7_0.1_0.1_train_duration_pca_no_whisper -->
