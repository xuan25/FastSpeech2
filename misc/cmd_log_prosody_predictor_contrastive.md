...
## sentiment_input - non-contrastive
...
## sentiment_input_concat - contrastive

python train_prosody_predictor_contrastive.py --dataset_config config/LibriTTS/dataset_sentiment.yaml --train_config config/LibriTTS/train_prosody_predictor_contrastive-0.1.yaml --model_config config/LibriTTS/model_sentiment_input_concat.yaml --output_dir output/prosody_predictor_contrastive/sentiment_input_concat-0.1

python train_prosody_predictor_contrastive.py --dataset_config config/LibriTTS/dataset_sentiment.yaml --train_config config/LibriTTS/train_prosody_predictor_contrastive-0.yaml --model_config config/LibriTTS/model_sentiment_input_concat.yaml --output_dir output/prosody_predictor_contrastive/sentiment_input_concat-0


## sentiment_input_concat - non-contrastive

python train_prosody_predictor.py --dataset_config config/LibriTTS/dataset_sentiment.yaml --train_config config/LibriTTS/train_prosody_predictor.yaml --model_config config/LibriTTS/model_sentiment_input_concat.yaml --output_dir output/prosody_predictor/sentiment_input_concat
